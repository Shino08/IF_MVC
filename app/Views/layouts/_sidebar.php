<?php
// Determina qué ítem del nav está activo. Las vistas pasan $active_nav = 'dashboard' | 'cotizaciones' | etc.
...
$links = [
    ...
    'cotizaciones' => ['href' => $base_url . '/dashboard/cotizaciones','label' => 'Solic. Cotización',  'icon' => 'M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z'],
...
<aside class="w-64 bg-white border-r border-gray-200 flex flex-col flex-shrink-0">
    ...
    <!-- Logo -->
    <div class="h-28 flex items-center justify-center px-6 border-b border-gray-200">
        <a href="<?= $base_url ?>/">
            <img src="<?= $base_url ?>/img/Photoroom-20251106_165742.png"
                 alt="InstalFuego Logo" class="h-20 object-contain">
        </a>
    </div>
    ...
    <div class="p-4 border-t border-gray-200">
        <div class="flex items-center space-x-3">
            <div class="w-9 h-9 rounded-full bg-red-700 text-white flex items-center justify-center font-bold text-sm flex-shrink-0">
                <?= strtoupper(substr($_SESSION['user_name'] ?? 'A', 0, 2)) ?>
            </div>
            <div class="flex-1 min-w-0">
                <p class="text-sm font-semibold text-gray-900 truncate"><?= htmlspecialchars($_SESSION['user_name'] ?? 'Administrador') ?></p>
