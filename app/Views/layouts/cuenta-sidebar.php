...
$is_carritos = strpos($current_route, 'mis-carritos') !== false;
...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 relative overflow-hidden">
    ...
    <div class="relative z-10">
        ...
        <nav class="flex flex-col space-y-3">
            ...
            <a href="<?= $base_url ?? '' ?>/mis-pedidos" class="flex items-center space-x-3 px-4 py-3.5 rounded-2xl font-semibold transition-all duration-300 <?= $is_carritos ? 'bg-red-50 text-red-700 shadow-sm border border-red-100' : 'text-gray-600 hover:bg-gray-50 hover:text-red-600 border border-transparent hover:border-gray-100' ?>">
                <svg class="w-5 h-5 <?= $is_carritos ? 'text-red-600' : 'text-gray-400' ?> transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
