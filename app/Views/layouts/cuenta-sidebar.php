...
<div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 relative overflow-hidden">
    ...
    <div class="relative z-10">
        ...
        <nav class="flex flex-col space-y-3">
            ...
            <a href="<?= $base_url ?? '' ?>/mis-cotizaciones" class="flex items-center space-x-3 px-4 py-3.5 rounded-2xl font-semibold transition-all duration-300 <?= $is_cotizaciones ? 'bg-red-50 text-red-700 shadow-sm border border-red-100' : 'text-gray-600 hover:bg-gray-50 hover:text-red-600 border border-transparent hover:border-gray-100' ?>">
