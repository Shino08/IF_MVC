        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-3/4">
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8 relative overflow-hidden">
                    ...
                    <form action="<?= $base_url ?>/cuenta/seguridad" method="POST" class="space-y-8 relative z-10">
                        ...
                        <div class="max-w-md">
                            ...
                            <p class="mt-2 text-xs text-gray-500 font-medium">Necesitamos tu contraseña actual para verificar tu identidad de forma segura.</p>
                        </div>
