        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-3/4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <a href="<?= $base_url ?>/mis-pedidos" class="group block p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:border-red-300 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-4 mb-4">
                            ...
                            <h3 class="text-lg font-bold text-gray-900">Mis Pedidos</h3>
                        </div>
                        <p class="text-gray-500 text-sm">Visualiza el historial y estado de todos tus pedidos.</p>
                    </a>
