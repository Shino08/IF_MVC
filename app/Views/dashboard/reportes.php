...
<body>
    <div class="report-header">
        ...
        <div class="right">
            <h1>REPORTE</h1>
            <p><strong>Tipo:</strong> <?= $tipo === 'cotizaciones' ? 'Solicitudes de Cotización' : 'Más Solicitados' ?></p>
    ...
    <div class="totals-box">
        <div class="row"><span>Total Cotizaciones:</span><strong><?= $totales['total_cotizaciones'] ?></strong></div>
          ...
          <form method="GET" action="<?= htmlspecialchars(rtrim(str_replace('/index.php', '', $_SERVER['SCRIPT_NAME']), '/')) ?>/dashboard/reportes" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <div>
              ...
              <select name="tipo" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                <option value="cotizaciones" <?= $tipo === 'cotizaciones' ? 'selected' : '' ?>>Solicitudes de Cotización</option>
          ...
          <div class="p-8" id="report-content">
            ...
            <div class="flex justify-between items-start mb-8 pb-6 border-b-2 border-gray-200">
              ...
              <div class="text-right">
                ...
                <p class="text-sm text-gray-600 mb-1"><span class="font-semibold">Tipo:</span> <?= $tipo === 'cotizaciones' ? 'Solicitudes de Cotización' : 'Más Solicitados' ?></p>
              ...
              <div class="w-96">
                <div class="bg-gray-50 rounded-lg p-4">
                  <div class="flex justify-between py-2 text-sm border-b border-gray-200">
                    <span class="text-gray-600">Total Cotizaciones:</span>
