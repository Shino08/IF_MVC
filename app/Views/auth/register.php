...
<head>
    ...
    <meta name="description" content="Crea tu cuenta empresarial en InstalFuego para solicitar carritos.">
        ...
        <div class="w-full md:w-3/4 max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-500 text-sm">Ingresa tus datos corporativos para acceder al catálogo técnico y solicitar carritos.</p>
                </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="password" name="password"
                                       ...
                                       class="w-full px-4 py-3 pr-12 bg-gray-50 border border-gray-200 rounded-lg outline-none transition duration-200 focus:ring-2 focus:ring-primary focus:border-transparent focus:bg-white"
                                       required>
