    ...
    <div class="max-w-4xl mx-auto px-4 print:px-0">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 print:hidden">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <form action="<?= $base_url ?? '' ?>/cotizacion/confirmar/<?= $cotizacion['id'] ?>" method="POST" class="inline">
                    <button type="submit" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-emerald-600 hover:bg-emerald-700 transition-colors shadow-md hover:shadow-lg">
                ...
                <a href="<?= \App\Core\Config::whatsappUrl('Cotización #COT-' . date('Y', strtotime($cotizacion['fecha_solicitud'])) . '-' . str_pad((string)$cotizacion['id'], 4, '0', STR_PAD_LEFT)) ?>" target="_blank" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 transition-colors shadow-md hover:shadow-lg">
